...
public class D17FileCopyPerformance {
  ...
  public static void main(String[] args) {
    ...
    copyByByte(); // 892.1351971 초
    // 대용량 이미지 일때, 메소드에 입출력 단위 지정 vs 자바의 버퍼클래스를 사용
    // -> 성능 차이 있음.
    // copyByByteArray(); // 1.409042 초
    // copyByBufferStream(); // 0.3380081 초
    // 실행 종료한 시간 저장
  ...
  public static void copyByBufferStream() {
    ...
    try {
      ...
      fis = new FileInputStream("C:\\Users\\C118\\Downloads\\test.tif");
      fos = new FileOutputStream("C:\\Users\\C118\\Downloads\\people1.tif");
  ...
  public static void copyByByte() { // 바이트 단위로 복사
    ...
    try {
      ...
      int count = 0;
      fis = new FileInputStream("C:\\Users\\C118\\Downloads\\test.tif");
      fos = new FileOutputStream("C:\\Users\\C118\\Downloads\\people3.tif");
