...
public class D18TextFileTest {
    ...
    public static void writeFileAutoClose() {
        ...
        try (// ✅close 가 필요한 선언
                FileWriter fw = new FileWriter(filename, Charset.forName("UTF-8"), true); // true : 기존 파일내용에 추가
    ...
    public static void writeFile() {
        ...
        try {
            ...
            pw = new PrintWriter(fw); // Char 지정은 가능하나 첫번째 인자 타입이 제한적
            String test = "PrintWrite는 FileWriter 또는 파일명을 인자로 사용합니다.";
            String[] lines = test.split("\\s+");
            for (int i = 0; i < lines.length; i++) {
                pw.println(lines[i]);
    ...
    public static void readByLine() {
        ...
        try {
            ...
            fr = new FileReader("C:\\Class250615\\0724_파일입출력.txt", Charset.forName("UTF-8"));
    ...
    public static void readText() {
        ...
        StringBuilder sb = new StringBuilder();
        try {
            fr = new FileReader("C:\\Class250615\\java_workspace\\partD\\text.txt", Charset.forName("UTF-8"));
