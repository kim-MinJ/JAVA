...
public class D04MemberList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("members 한번 더 출력");
        ...
        // 3) members 정렬확인하기 : 오류 => 불변 객체이므로 sort 못합니다.
        ...
        // members2.sort((o1, o2) -> o1.getName().compareTo(o2.getName()));
        // 람다식으로도 가능

        // compare 와 compareTo 메소드 비교는 C12 번 소스 파일 참고
        System.out.println("정렬 후 (name 비교) : ");
        for (Member m : members2) {
            System.out.println("\t" + m);
        }

        // 두번째 정렬은 point 속성값으로 합시다.
        /*
         * members2.sort(new Comparator<Member>() {
         * 
         * @Override
