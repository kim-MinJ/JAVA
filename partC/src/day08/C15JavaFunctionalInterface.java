...
//인자만 있는 Consumer, 리턴만 있는 Supplier, 둘 다 있는 Function : 제너릭 타입
    ...
    public static void main(String[] args) {
        ...
        Consumer<Double> f2 = new Consumer<Double>() {
            ...
            public void accept(Double t) {
                System.out.println("Consumer aceept : " + t); // 인자 O, 리턴 X
            }
        };
        Consumer<Double> f22 = (t) -> System.out.println("Consumer aceept : " + t);
        ...
        Supplier<Integer> f3 = new Supplier<Integer>() {
            @Override
            public Integer get() {
                return 100; // 인자 X 리턴 O
            }
        };

        System.out.println(f3.get());

        // 3. Function<T, R> : T 는 인자1개 타입, R은 리턴 타입
