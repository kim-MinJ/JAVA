...
public class B18ArrayTest {
    public static void main(String[] args) {
        ...
        System.out.println("arr1 : " + arr1); // arr1 : [I@4517d9a3 에서 [I int 배열 그 뒤는 참조값
        ...
        // 자바는 배열 관련 메소드는 Arrays 클래스와 static 메소드 사용합니다.

        // 1. 배열 의 값들을 하나의 문자열로 리턴
        ...
        System.out.println("실수배열 요소값 비교 : " + Arrays.equals(darr1, darr2)); // true
